      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full  xl:block xl:w-1/2 ">
            <div className="py-17.5 px-26 text-center animate__animated animate__backInLeft">
              <Link
                className="mb-5.5 inline-block animate__animated animate__bounce"
                to="/"
              >
                <img className="hidden dark:block" src={Logo} alt="Logo" />
                <img className="dark:hidden" src={LogoDark} alt="Logo" />
              </Link>
              <p className="2xl:px-20  animate__animated animate__bounce">
              ...
              <span className="">
                ...
                >
                  ...
                  <rect
                    ...
                    fill="#30374e"
                  />
                  <circle cx="672.39" cy="560.74" r="13.57" fill="#3C50E0CC" />
                  <circle cx="672.39" cy="560.74" r="13.57" opacity="0.1" />
                  <circle cx="673.15" cy="559.02" r="13.57" fill="#3C50E0CC" />
                  <path
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2 animate__animated animate__backInRight">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form className="" onSubmit={formik.handleSubmit}>
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute right-4 top-4">
                      ...
                      >
                        <switch>
                          <g>
                            <path d="M30.9 120c-6.4 0-12.9-2.4-17.7-7.3l-1.8-1.7 99.5-99.5 1.7 1.7c9.8 9.8 9.8 25.7 0 35.5l-64 64c-4.8 4.9-11.3 7.3-17.7 7.3zm-12.4-9.2c7.9 6.2 19.4 5.6 26.7-1.6l64-64c7.3-7.3 7.8-18.8 1.6-26.7l-92.3 92.3z" />
                            <path d="M84.2 45.1 69.3 30.2 99.5 0l14.9 14.9-30.2 30.2zm-7.9-14.9 7.9 7.9 23.2-23.2L99.5 7 76.3 30.2zM14.9 114.4 0 99.5l30.2-30.2 14.9 14.9-30.2 30.2zM7 99.5l7.9 7.9 23.2-23.2-7.9-7.9L7 99.5z" />
                          </g>
                        </switch>
                      </svg>
                    </span>
                ...
                {/* Display error if touched and has an error */}
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link to="/s" className="text-primary">
                      Sign Up
                    </Link>
                  </p>
                </div>
